var systemComponents = {
	...
	'overlay-head': {
		...
		<br>
		<span class="overlayThing" style="opacity: 60%;">{{canGenPoints() ? (tmp.other.oompsMag != 0 ? format(tmp.other.oomps) + " OOM" + (tmp.other.oompsMag < 0 ? "^OOM" : tmp.other.oompsMag > 1 ? "^" + tmp.other.oompsMag : "") + "s" : "(" + formatSmall(getPointGen()) + "/s)") : "Buy the first upgrade to start."}}</span>
